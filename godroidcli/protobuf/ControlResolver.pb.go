...
// UnimplementedControlResolverServer can be embedded to have forward compatible implementations.
...
func RegisterControlResolverServer(s *grpc.Server, srv ControlResolverServer) {
	s.RegisterService(&_ControlResolver_serviceDesc, srv)
}
...
var _ControlResolver_serviceDesc = grpc.ServiceDesc{
